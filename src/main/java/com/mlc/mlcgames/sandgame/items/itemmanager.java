...
public class itemmanager {
    ...
    public static List<ItemStack> canspawnitems = new ArrayList<>();
    ...
    public static void init(){
        ...
        sand.editMeta(meta -> {
            ...
            meta.lore(List.of(miniMessage.deserialize("<!i><gold><b>重要材料")));
        });

        baseitem_sword = new ItemStack(Material.WOODEN_SWORD);
        baseitem_sword.editMeta(meta -> {
            meta.displayName(miniMessage.deserialize("<!i><b><white>木剑"));
            meta.lore(List.of(miniMessage.deserialize("<!i><gray>最基本的武器")));
        ...
        team_1_wool.editMeta(meta -> {
            meta.displayName(miniMessage.deserialize("<!i><b><#ff5555>红队徽章"));
            meta.lore(List.of(miniMessage.deserialize("<!i><gray>点击加入红队")));
        });

        team_2_wool = new ItemStack(Material.BLUE_WOOL);
        team_2_wool.editMeta(meta -> {
            meta.displayName(miniMessage.deserialize("<!i><b><#55aaff>蓝队徽章"));
            meta.lore(List.of(miniMessage.deserialize("<!i><gray>点击加入蓝队")));
        });

        baseitem_helmet_1 = new ItemStack(Material.LEATHER_HELMET);
        baseitem_helmet_1.editMeta(LeatherArmorMeta.class, meta -> {
            meta.displayName(miniMessage.deserialize("<!i><b><#ff5555>红队皮甲头盔"));
            meta.lore(List.of(miniMessage.deserialize("<!i><gray>红队基础护甲")));
            meta.setUnbreakable(true);
        ...
        baseitem_helmet_2.editMeta(LeatherArmorMeta.class, meta -> {
            meta.displayName(miniMessage.deserialize("<!i><b><#55aaff>蓝队皮甲头盔"));
            meta.lore(List.of(miniMessage.deserialize("<!i><gray>蓝队基础护甲")));
            meta.setUnbreakable(true);
        ...
        bow.editMeta(meta -> {
            meta.displayName(miniMessage.deserialize("<!i><b><white>弓"));
            meta.lore(List.of(miniMessage.deserialize("<!i><gray>远程射击")));
            meta.setUnbreakable(true);
        });

        potion_speed = new ItemStack(Material.POTION);
        potion_speed.editMeta(PotionMeta.class, meta -> {
            meta.displayName(miniMessage.deserialize("<!i><b><#55ffff>迅捷药水"));
            meta.lore(List.of(miniMessage.deserialize("<!i><gray>提升移动速度")));
        ...
        potion_jump.editMeta(PotionMeta.class, meta -> {
            meta.displayName(miniMessage.deserialize("<!i><b><#88ff88>跳跃药水"));
            meta.lore(List.of(miniMessage.deserialize("<!i><gray>提升跳跃高度")));
        ...
        potion_regeneration.editMeta(PotionMeta.class, meta -> {
            meta.displayName(miniMessage.deserialize("<!i><b><#ff55ff>再生药水"));
            meta.lore(List.of(miniMessage.deserialize("<!i><gray>缓慢恢复生命")));
        ...
        cooked_beef = new ItemStack(Material.COOKED_BEEF,16);
        cooked_beef.editMeta(meta -> {
        ...
        canspawnitems.add(arrow);
        canspawnitems.add(cooked_beef);
        canspawnitems.add(potion_speed);
        canspawnitems.add(potion_jump);
        canspawnitems.add(potion_regeneration);
    ...
    public static void giveBaseItems(Player player){
        ...
        if(team.equals(Teammanager.sandgame_team_1)){
            player.getInventory().setHelmet(baseitem_helmet_1);
        }else if(team.equals(Teammanager.sandgame_team_2)){
            player.getInventory().setHelmet(baseitem_helmet_2);
        }
        player.getInventory().addItem(baseitem_sword);
        player.getInventory().addItem(arrow);
        player.getInventory().addItem(bow);
        player.getInventory().addItem(cooked_beef);
    }

    public static void spawnsand(Location loc){
        Item item = loc.getWorld().dropItem(loc, sand);
    ...
    private static @NotNull ItemStack getrandomItem() {

        return canspawnitems.get((int)(Math.random()*canspawnitems.size()));

    }

    public static void spawnmoney(Location loc){
        Item item = loc.getWorld().dropItem(loc, emerald);
        item.setVelocity(new Vector(0,0,0.));
        item.setGlowing(true);
    }
