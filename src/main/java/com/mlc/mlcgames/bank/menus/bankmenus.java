...
public class bankmenus {
    ...
    public static void init(){
        ...
        policemenu = Bukkit.createInventory(null,9*5, Component.text("职业选择菜单"));
        thiefmenu = Bukkit.createInventory(null,9*5, Component.text("职业选择菜单"));
        ...
        bankmenu.setItem(3, Bankgameitemmanager.netheritesword);
