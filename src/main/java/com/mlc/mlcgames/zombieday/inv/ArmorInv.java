...
public class ArmorInv {
    ...
    public static void  init(){
        ...
        merchantRecipe6.setIngredients(List.of(emeraldStack,emeraldStack));

        MerchantRecipe merchantRecipe7 = new MerchantRecipe(Item.iron_leggings,0, 999,false);
        merchantRecipe7.setIngredients(List.of(emeraldStack,emeraldStack));

        MerchantRecipe merchantRecipe8 = new MerchantRecipe(Item.iron_boots,0, 999,false);
        merchantRecipe8.setIngredients(List.of(emeraldStack,emeraldStack));
        ...
        merchantRecipe10.setIngredients(List.of(emeraldStack,emeraldStack));

        MerchantRecipe merchantRecipe11 = new MerchantRecipe(Item.neitherite_leggings,0, 999,false);
        merchantRecipe11.setIngredients(List.of(emeraldStack,emeraldStack));

        MerchantRecipe merchantRecipe12 = new MerchantRecipe(Item.neitherite_boots,0, 999,false);
        merchantRecipe12.setIngredients(List.of(emeraldStack,emeraldStack));
